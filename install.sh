...
TAG="v1.0"
NFD_LOG_X86_DOWNLOAD_URL="https://github.com/Quarmire/nfd-log/releases/download/$TAG/nfd_log_x86_64"
NFD_LOG_AARCH64_DOWNLOAD_URL="https://github.com/Quarmire/nfd-log/releases/download/$TAG/nfd_log_aarch64"
NFD_READ_X86_DOWNLOAD_URL="https://github.com/Quarmire/nfd-log/releases/download/$TAG/nfd_read_x86_64"
NFD_READ_AARCH64_DOWNLOAD_URL="https://github.com/Quarmire/nfd-log/releases/download/$TAG/nfd_read_aarch64"
